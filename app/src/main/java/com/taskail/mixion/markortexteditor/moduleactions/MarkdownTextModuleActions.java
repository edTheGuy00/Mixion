...
public class MarkdownTextModuleActions extends TextModuleActions {
    ...
    public MarkdownTextModuleActions(Activity activity) {
        super(activity);
    }
    ...
    private class KeyboardExtraActionsListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            switch (_action) {
                case 3: {
                    //new //CommonTextModuleActions(_activity, _hlEditor).runAction(CommonTextModuleActions.ACTION_SPECIAL_KEY);
                    break;
                }
                default: {
